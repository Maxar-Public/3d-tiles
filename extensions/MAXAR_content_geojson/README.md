...
Written against the 3D Tiles 1.1 specifications.
...
- **Tileset Schema**: [`tileset.MAXAR_content_geojson.schema.json`](schema/tileset.MAXAR_content_geojson.schema.json)
- **Metadata Entity Schema**: [`metadataEntity.MAXAR_content_geojson.schema.json`](schema/metadataEntity.MAXAR_content_geojson.schema.json)
- **Properties Schema**: [`geojsonproperties.schema.json`](schema/geojsonproperties.schema.json)
